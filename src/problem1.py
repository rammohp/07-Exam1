...
def problem1a(a, b, threshold):
    ...
    for k in range(b):
        if k+1 >= a:
            if product_of_digits(k+1) < threshold:
                total = total + k+1
...
def run_test_problem1b():
    ...
    # Test 3:
    expected = 7 + 10 + 11 + 12 + 13 + 14 + 15 + 16 + 17 + 20 + 21 + 22 + 23 + 30 + 31 + 32 + 40 + 41
    answer = problem1b(7)
    print()
    print('Test 3 is: problem1b(7)')
    print('  Expected:', expected)
    print('  Actual:  ', answer)
